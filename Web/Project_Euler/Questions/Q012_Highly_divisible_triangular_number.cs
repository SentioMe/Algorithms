...
namespace Project_Euler
{
     ...
     */
    public class Q012_Highly_divisible_triangular_number : IQuestionable<int>
    {
        public bool Ask()
        {
            var sb = new StringBuilder();
            sb.Append("The sequence of triangle numbers is generated by adding the natural numbers. So the 7th triangle number would be 1 + 2 + 3 + 4 + 5 + 6 + 7 = 28. The first ten terms would be:");
            sb.Append("\n\n");
            sb.Append("1, 3, 6, 10, 15, 21, 28, 36, 45, 55, ...");
            sb.Append("\n\n");
            sb.Append("Let us list the factors of the first seven triangle numbers:");
            sb.Append("\n\n");
            sb.Append(" 1: 1\n 3: 1,3\n 6: 1,2,3,6\n10: 1,2,5,10\n15: 1,3,5,15\n21: 1,3,7,21\n28: 1,2,4,7,14,28");
            sb.Append("\n\n");
            sb.Append("We can see that 28 is the first triangle number to have over five divisors.\nWhat is the value of the first triangle number to have over N divisors?");
        ...
        public int[] Arguments { get { return new int[] { (int)Input.Decimal("Please enter the natural number N.") }; } }
